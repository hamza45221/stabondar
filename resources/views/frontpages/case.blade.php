...
@section('content')
    ...
    <main data-transition="container" data-transition-page="case-inner">
    <header class="case-hero" case-name="depo-studio">
        <div class="case-hero_left">
            <div class="case-hero_items">
        ...
        <div class="num_col is-left">
            <div class="num_list">
                <div class="num_item">
                    ...
                    <div class="num_text f-12">214</div>
                </div>
                <div class="num_item">
                    <div class="num_dot"></div>
                    <div class="num_text f-12">214</div>
...
<div class="canvas-container"> <canvas class="canvas"></canvas> </div> <vercel-analytics data-props="{}"
                                                                                         data-params="{}" data-pathname="/cases/depo-studio/"></vercel-analytics>
<script
