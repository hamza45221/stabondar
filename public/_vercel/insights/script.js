...
(() => {
    ...
    (t = () => {
        i(), function () {
            let t = e => e, n = document, a = n.currentScript,
                r = (null == a ? void 0 : a.dataset.endpoint) || (null != a && a.src.includes("/va/") ? "/va" : "/_vercel/insights"),
                i = null == a ? void 0 : a.dataset.disableAutoTrack, o = null, l = null, s = !0;
            ...
            let w = e(), y = () => {
                ...
                window.va = function (e, n) {
                    "beforeSend" === e ? t = n : "event" === e ? n && p(n.name, n.data, n.options) : "pageview" === e && n && (n.route && (o = n.route), n.path && (l = n.path), d({withReferrer: s}), s = !1), "enableCookie" === e && f()
